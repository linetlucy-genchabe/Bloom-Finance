...
urlpatterns = [
    ...
    # Analysis
    path('analysis/', views.monthly_analysis, name='analysis'),
    # Expenses
    ...
    path('subscriptions/add-from-expense/',   views.subscription_add_from_expense, name='subscription_add_from_expense'),
